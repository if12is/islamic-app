...
class AppConstants {
  ...
  /// How long the parsed Azkar payload stays in Hive before being re-read
  /// from the bundled asset.
  static const Duration azkarCacheDuration = Duration(days: 30);

  /// Reading log, khatmah plan, and daily wird targets.
  static const String khatmahPlanKey = 'khatmah_plan_v1';
  static const String dailyWirdTargetsKey = 'daily_wird_targets_v1';
